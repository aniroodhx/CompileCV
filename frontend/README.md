...
- **Deterministic ATS Scoring** — Keyword normalization, alias mapping, and weighted scoring (required 70%, preferred 30%)
- **AI Bullet Rewrites** — Gemini rewrites your bullet points to naturally include missing keywords
...
- **Zero Data Persistence** — Resumes are parsed in-memory and never stored
...
```bash
cd backend
# Add GEMINI_API_KEY and GEMINI_API_URL to application.properties
mvn spring-boot:run
```
